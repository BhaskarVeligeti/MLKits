...
let { features, labels, testFeatures, testLabels } = loadCSV('cars.csv', {
  shuffle: true,
  splitTest: 200, // half of features data
...
// console.log(' Coefficent of Determination : ', R2, '%', '|', R2_); //Coefficent of Determination :  71 % | 0.7121984470881169
...
console.log(' observations (horsepower,weight,displacement)  : ', observations);
const predictionMPG = regression.predict(observations);
predictionMPG.print();


/*
  observations (horsepower,weight,displacement)  :  [ [ 120, 2, 380 ], [ 135, 2.1, 420 ] ]
Tensor
    [
      [16.1630268],
      [14.1873779]
